...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  1 16:54:51 2020
...
for i in range(0,10): 
    ...
    s2 = np.load("s2_dataset"+stri+".npy")
    W = np.load("W_dataset"+stri+".npy")
    t = np.load("t_dataset"+stri+".npy")
    ...
    #np.save('./'+path+'/s1_'+strP+'particles_dataset'+stri,s1)
    #np.save('./'+path+'/s2_'+strP+'particles_dataset'+stri,s2)
    #np.save('./'+path+'/t_'+strP+'particles_dataset'+stri,t)
    
    

    np.save('./'+path+'/A_'+strP+'particles_dataset'+stri,Alist)
