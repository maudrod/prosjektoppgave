...
plt.xlim([0,0.08])
plt.legend()
plt.title('Posterior distribution Tau - 0.0001 noise - 2ms - $b_1 = b_2$ = -2.75')
plt.show()
'''
plt.figure()
plt.title('Tau inference - 0.005 noise - 2ms - $b_1 = b_2$ = -2.75')
plt.xlabel('Iteration')
plt.ylabel('Tau')
plt.ylim([0,0.08])
plt.plot(np.linspace(1,1500,1500),Tau8,'ko')
plt.axhline(0.02,color='r',linestyle='--',label='True Value')
plt.legend()
plt.show()
'''