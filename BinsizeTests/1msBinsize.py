...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 10 13:17:34 2020
...
for i in range(100):
    ...
    for j in range(len(taus2)):
        particlelogliks3.append(particle_filter(w0est22,b2est22,Ap,s122,s222,std,P,binsize,seconds,taus2[j]))
...
for i in range(100):
    ...
    w0est2 = infer_b2_w0(s12[:10000], s22[:10000], 1e-10)[1]
    wests.append(w0est2)
    particlelogliks2 = []
    for j in range(len(taus2)):
...
np.save('w0estimates_2ms_b1m2.75',wests2)
np.save('Loglikes_2msb1m2.75',loglikes2)
np.save('loglikes_1ms_m3.5',loglikes)
np.save('w0estmates_1ms_m3.5',wests)
np.save('EndConnections2ms2.75',ends2)
np.save('EndConnections1ms3.5',ends)
