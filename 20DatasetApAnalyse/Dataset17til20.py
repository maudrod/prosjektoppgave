...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 17 19:31:24 2020
...
np.save('S1Datasets17to20',s1s)
np.save('S2Datasets17to20',s2s)
np.save('b1sDatasets17to20',b1ests)
np.save('b2sDatasets17to20',b2ests)
np.save('ApInferenceData17to20',Aps)
np.save('w0ests17to20',w0ests)