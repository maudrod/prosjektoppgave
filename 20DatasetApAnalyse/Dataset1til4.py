...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 17 19:29:45 2020
...
np.save('S1Datasets1to4',s1s)
np.save('S2Datasets1to4',s2s)
np.save('b1sDatasets1to4',b1ests)
np.save('b2sDatasets1to4',b2ests)
np.save('ApInferenceData1to4',Aps)
np.save('w0ests1to4',w0ests)
np.save('Noises',stds)
