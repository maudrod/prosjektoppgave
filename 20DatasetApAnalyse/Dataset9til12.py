...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 17 19:30:46 2020
...
np.save('S1Datasets9to12',s1s)
np.save('S2Datasets9to12',s2s)
np.save('b1sDatasets9to12',b1ests)
np.save('b2sDatasets9to12',b2ests)
np.save('ApInferenceData9to12',Aps)
np.save('w0ests9to12',w0ests)