...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 10 20:31:01 2020
...
def MHsampler(w0,b2est,shapes_prior,rates_prior,s1,s2,std,P,binsize,seconds,U,it):
    ...
    old_log_post = particle_filter(w0,b2est,theta_prior,s1,s2,std,P,binsize,seconds)
    for i in range(1,it):
        if (i % U == 0):
            shapes, theta_next = adjust_variance(theta,U,it,shapes)
        else:    
            theta_next = proposal_step(shapes,theta_prior)
        new_log_post = particle_filter(w0,b2est,theta_next,s1,s2,std,P,binsize,seconds)
...
np.save('Sim0.0001noiseSame2',Simest1)
np.save('Sim0.0005noiseSame2',Simest2)
np.save('Sim0.001noiseSame2',Simest3)
np.save('Sim0.002noiseSame2',Simest4)
np.save('Sim0.003noiseSame2',Simest5)
np.save('Sim0.004noiseSame2',Simest6)
np.save('Sim0.005noiseSame2',Simest7)

np.save('Alt0.0001noiseSame2',Altest1)
np.save('Alt0.0005noiseSame2',Altest2)
np.save('Alt0.001noiseSame2',Altest3)
np.save('Alt0.002noiseSame2',Altest4)
np.save('Alt0.003noiseSame2',Altest5)
np.save('Alt0.004noiseSame2',Altest6)
np.save('Alt0.005noiseSame2',Altest7)
