...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 10 20:30:50 2020
...
Tauest2 = MHsampler2(w0est, b2est, shapes_prior, rates_prior, s1, s2, std, P, binsize, seconds, U, it, Ap)
...
Tauest4 = MHsampler2(w0est, b2est, shapes_prior, rates_prior, s1, s2, std, P, binsize, seconds, U, it, Ap)
...
Tauest6 = MHsampler2(w0est, b2est, shapes_prior, rates_prior, s1, s2, std, P, binsize, seconds, U, it, Ap)
...
np.save('Tau0.0001noise',Tauest1)
np.save('Tau0.0005noise',Tauest2)
np.save('Tau0.001noise',Tauest3)
np.save('Tau0.002noise',Tauest4)
np.save('Tau0.003noise',Tauest5)
np.save('Tau0.004noise',Tauest6)
np.save('Tau0.005noise',Tauest7)
