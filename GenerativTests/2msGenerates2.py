...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 11 20:34:09 2020
...
np.save('Trajectories2ms_bm3.1',W5ms)
np.save('B1estimates2ms_bm3.1',b1ests)
np.save('B2estimates2ms_bm3.1',b2ests)
np.save('w0estimates2ms_bm3.1',w0ests)
