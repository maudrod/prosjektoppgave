...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 11 20:20:36 2020
...
np.save('Trajectories5ms',W5ms)
np.save('B1estimates5ms',b1ests)
np.save('B2estimates5ms',b2ests)
np.save('w0estimates5ms',w0ests)
